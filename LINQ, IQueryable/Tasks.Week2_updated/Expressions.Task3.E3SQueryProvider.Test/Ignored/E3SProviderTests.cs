...
namespace Expressions.Task3.E3SQueryProvider.Test.Ignored
{
   ...
   public class E3SProviderTests
   {
      ...
      public void WithoutProvider()
      {
         ...
         query.Add("workstation:(EPRUIZHW0249)");
         IEnumerable<EmployeeEntity> res = searchService.Value.SearchFts<EmployeeEntity>(query, 0, 1);
      ...
      public void WithoutProviderNonGeneric()
      {
         ...
         var query = new List<string>();
         query.Add("workstation:(EPRUIZHW0249)");
         var res = searchService.Value.SearchFts(typeof(EmployeeEntity), query, 0, 10);
